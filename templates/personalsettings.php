<fieldset id="notesPersonalSettings" class="section">
	...
	<br />
	<?php p($l->t("Default tags"));?>:
	<input type="text" id="default_tags" value="<?php p(isset($_['default_tags'])?$_['default_tags']:''); ?>"
		placeholder="Default tags to show. Comma-separated list"/>
	<br />
	<br />
